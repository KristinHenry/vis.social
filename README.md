...
* Case: post is not in English and doesn't have an English translation
	...
	* Reply with 
	```
	Just a reminder that "English is the common language of the instance. Other languages are welcome, but please be kind and post English translations so that we can all read your posts on the Local Timeline. Alternatively, you could edit your post and set it as ulisted or followers only."  https://vis.social/about
	```
